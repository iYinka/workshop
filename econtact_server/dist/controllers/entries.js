...
exports.updateContact = exports.getOccupations = exports.getContact = exports.getAllContacts = exports.deleteContact = exports.createContact = void 0;
...
var occupations = [_defineProperty(_defineProperty({
  id: 1,
  name: "Actor"
}, "id", 2), "named", "Engineer")];
...
var getContact = exports.getContact = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _contactModel["default"].findById(req.user.id, req.body);
        case 3:
          contact = _context2.sent;
          if (!contact) {
            res.status(404).send({
              message: "No entry with id: ".concat(req.params.id, " found")
            });
          } else {
            res.send(contact);
          }
        ...
        case 7:
          ...
          res.status(500).send({
            message: "Error retrieving entry with id: ".concat(req.params.id)
          });
        case 10:
        case "end":
  ...
  return function getContact(_x3, _x4) {
...
var createContact = exports.createContact = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var contact, contactExists, new_contact, _contact;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          // new ENTRY
          contact = new _contactModel["default"]({
            user: req.user.id,
            name: req.body.name,
          ...
          _context3.prev = 2;
          _context3.next = 5;
          return _contactModel["default"].findOne({
            user: req.user.id,
            phoneNumber: req.body.phoneNumber
          });
        case 5:
          contactExists = _context3.sent;
          if (!contactExists) {
            _context3.next = 10;
            break;
          }
          return _context3.abrupt("return", res.status(400).send({
            msg: "Contact's phone number exists"
          }));
        case 10:
          _context3.next = 12;
          return contact.save();
        case 12:
          new_contact = _context3.sent;
          _context3.next = 15;
          return _contactModel["default"].find();
        case 15:
          _contact = _context3.sent;
          _contact.push(_objectSpread({}, new_contact));
          res.status(201).json({
            success: true,
...
var updateContact = exports.updateContact = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body, name, email, phoneNumber, occupation, description, isActive, user, contact, updatedContact;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return _context4.abrupt("return", res.status(400).send({
            message: "Entry to update can not be empty"
          }));
        case 3:
          _req$body = req.body, name = _req$body.name, email = _req$body.email, phoneNumber = _req$body.phoneNumber, occupation = _req$body.occupation, description = _req$body.description, isActive = _req$body.isActive;
          _context4.next = 6;
        ...
        case 25:
          ...
          if (!updatedContact) {
            res.status(404).send({
              ...
              message: "Can not update entry with ".concat(id, ". Maybe entry not found!")
            });
          } else {
            res.status(201).json({
              success: true,
...
var deleteContact = exports.deleteContact = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var user, contact, deletedContact;
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 19:
          ...
          if (!deletedContact) {
            ...
            res.status(201).json({
              success: true,
              message: "Entry with ID: ".concat(deletedContact.id, " deleted successfully")
            });
          }
          _context5.next = 26;
          break;
...
var getOccupations = exports.getOccupations = function getOccupations(req, res) {
